...
Los datos fueron obtenidos desde ![Directorio de Transporte Público Metropolitano](http://www.dtpm.gob.cl/index.php/documentos/matrices-de-viaje) como tablas agregadas para el año 2019.

```{r}
library(shiny)
shinyAppFile("app.R", options = list(height = 600))
```
